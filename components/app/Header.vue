        ...
        <div class="container flex items-center justify-between w-full">
            ...
            <div class="flex space-x-4 items-center pr-4 sm:pr-0">
                ...
                <nuxt-link to="/cart" class="relative">
                    <span
                        class="absolute -top-2 -right-2 rounded-full w-4 h-4 flex items-center justify-center bg-primary text-white text-sm"
                        >{{ cart.length }}</span
                    >
                    <svg
                ...
                <div class="relative sm:hidden">
                    ...
                    >
                        <div
                            class="absolute rounded-lg transtion duration-200 p-4 flex flex-col space-y-4 w-32 shadow bg-white top-10 right-2"
                            v-if="isMenuOpen"
                        >
                            <nuxt-link
                                to="/auth/login"
